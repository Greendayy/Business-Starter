...
export default function ServiceCard(props) {
    return (
        <div className="shadow-3xl px-5 py-12 hover:scale-105 w-88 h-full mx-auto">
            ...
            <div className="flex flex-col items-center">
                <input className="transition delay-150 duration-300 ease-in-out  border rounded-lg mt-5 h-12 px-10 bg-neutral text-white px-3 text-center text-xl tracking-wide" type="button" value="Learn More" readOnly></input>
            </div>
        </div>
    )
}