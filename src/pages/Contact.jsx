    ...
    return(
        <main className="py-4">
            {  <TextCard
                {...textData[4]}
            />}
            <div className="flex flex-col-reverse py-9 px-9 sm:flex-row sm:px-12">
                <form className="h-full flex flex-col space-y-5 sm:space-y-2 sm:pl-6 sm:w-1/2 sm:px-2 sm:pr-4 ">
                    ...
                    <input className="border rounded-lg text-xl h-12 bg-neutral text-white tracking-wide" type="button" value="Submit" readOnly></input>
                </form>
                <img className="mb-8 sm:mb-0 sm:w-1/2" src={Map} /></div>
